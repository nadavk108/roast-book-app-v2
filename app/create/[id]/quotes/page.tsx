...
export default function QuotesPage() {
    ...
    // If we land on describe step with traits in URL (pre-generation may have failed),
    // auto-generate quotes so users don't see the traits form again.
    useEffect(() => {
        if (loading || generating || hasAutoGenerated.current) return;
